function  f2p = imshow3dim( Img, disprange )
%imshow3dim displays 3D grayscale images in slice by slice fashion with mouse
%based slice browsing and window and level adjustment control.
%
% Usage:
% imshow3dim ( Image )
% imshow3dim ( Image , [] )
% imshow3dim ( Image , [LOW HIGH] )
%   
